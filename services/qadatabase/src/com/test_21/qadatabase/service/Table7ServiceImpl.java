 ...
 */
@Service("qadatabase.Table7Service")
public class Table7ServiceImpl implements Table7Service {
    ...
    @Autowired
    @Qualifier("qadatabase.Table7Dao")
    ...
    @Transactional(readOnly = true, value = "qadatabaseTransactionManager")
    @Override
    public Table7 findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding table7 by id: {}" , id);
        Table7 table7=this.wmGenericDao.findById(id);
        if(table7==null){
            LOGGER.debug("No table7 found with id: {}" , id);
    ...
    public Table7 update(Table7 updated) throws EntityNotFoundException {
        LOGGER.debug("Updating table7 with information: {}" , updated);
