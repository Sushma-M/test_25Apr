...
@Service
public class QadatabaseQueryExecutorServiceImpl implements QadatabaseQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(QadatabaseQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("qadatabaseWMQueryExecutor")
