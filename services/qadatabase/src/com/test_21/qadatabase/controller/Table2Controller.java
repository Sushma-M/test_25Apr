...
import com.test_21.qadatabase.service.Table2Service;
import java.io.*;
 ...
 * @see com.test_21.qadatabase.Table2
 */
@RestController(value = "Qadatabase.Table2Controller")
@RequestMapping("/qadatabase/Table2")
...
public class Table2Controller {
    ...
    @Autowired
    @Qualifier("qadatabase.Table2Service")
    ...
    public Table2 editTable2(@PathVariable(value = "id") Integer id, @RequestBody Table2 instance) throws EntityNotFoundException {
    ...
    public boolean deleteTable2(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
