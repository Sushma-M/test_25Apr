...
import com.test_21.qadatabase.service.FollowUpsService;
import java.io.*;
 ...
 * @see com.test_21.qadatabase.FollowUps
 */
@RestController(value = "Qadatabase.FollowUpsController")
@RequestMapping("/qadatabase/FollowUps")
...
public class FollowUpsController {
    ...
    @Autowired
    @Qualifier("qadatabase.FollowUpsService")
