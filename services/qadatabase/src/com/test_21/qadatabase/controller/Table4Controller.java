 ...
 * @see com.test_21.qadatabase.Table4
 */
@RestController(value = "Qadatabase.Table4Controller")
@RequestMapping("/qadatabase/Table4")
...
public class Table4Controller {
    ...
    public Table4 getTable4(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public Table4 editTable4(@PathVariable(value = "id") Integer id, @RequestBody Table4 instance) throws EntityNotFoundException {
    ...
    public boolean deleteTable4(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
