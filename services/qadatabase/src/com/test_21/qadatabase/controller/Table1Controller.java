...
import com.test_21.qadatabase.service.Table1Service;
import java.io.*;
 ...
 * @see com.test_21.qadatabase.Table1
 */
@RestController(value = "Qadatabase.Table1Controller")
@RequestMapping("/qadatabase/Table1")
...
public class Table1Controller {
    ...
    @Autowired
    @Qualifier("qadatabase.Table1Service")
    ...
    public Table1 editTable1(@PathVariable(value = "id") Integer id, @RequestBody Table1 instance) throws EntityNotFoundException {
